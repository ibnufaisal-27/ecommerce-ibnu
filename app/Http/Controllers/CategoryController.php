...
class CategoryController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        //JIKA KATEGORI INI TIDAK DIGUNAKAN SEBAGAI PARENT ATAU CHILDNYA = 0 dan apakah sudah digunakan di product atau belum
        ...
        elseif ($category->child_count > 0) {
            return redirect(route('category.index'))->with(['error' => 'Kategori Ini Memiliki Anak Kategori!']);
        } else {
            return redirect(route('category.index'))->with(['error' => 'Kategori Ini Dipakai Dalam Product Aktif!']);
        }
    }
}
